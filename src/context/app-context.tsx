...
function getInitialState(): AppState {
  ...
  return {
    ...
    chatListMeta: {
      ...
      c2: { branchOpened: true },
      c3: { pendingAdditions: 5, pendingDeletions: 2, worktreeOpen: true },
      c4: { branchMerged: true, pendingAdditions: 3, pendingDeletions: 1 },
      c5: { branchOpened: true, branchesCount: 2, worktreesCount: 1 },
      c6: { worktreeOpen: true, worktreesCount: 2 },
      c7: { branchMerged: true },
      c8: { branchOpened: true, branchesCount: 1 },
      c9: {},
    },
    openChats: [],
